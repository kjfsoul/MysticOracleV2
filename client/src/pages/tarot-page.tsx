...
import { apiRequest } from "@/lib/api"; // Updated import
...
export default function TarotPage() {
  ...
  const [currentReading, setCurrentReading] = useState<TarotReadingType | null>(
    null
  );
  ...
  return (
    <div
      className="min-h-screen bg-dark bg-[radial-gradient(circle_at_10%_20%,rgba(74,33,116,0.2)_0%,rgba(26,26,74,0.1)_80%)]"
      style={{
        backgroundImage: `
                ...
                >
                  <div className="space-y-2">
                    <p className="text-light/80 max-w-2xl mx-auto">
                      Ask a specific question or focus on a situation as you
                      select your cards. The tarot will provide personalized
                      insight.
                    </p>
                    <div className="flex justify-center items-center mt-4">
                      <Link
                        to="/tarot-cards"
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-purple-900/30 hover:bg-purple-900/50 text-purple-200 rounded-full border border-purple-500/30 transition-all duration-300 mystic-glow"
                      >
              ...
              >
                <div className="text-center mb-8">
                  <div className="flex justify-center items-center gap-2 mb-2">
                    <h3 className="font-heading text-2xl font-semibold text-accent/90">
                      Choose Your Spread
                    </h3>
                    <Button
                      variant="ghost"
                      ...
                      >
                        <div className="bg-dark/40 border border-light/10 rounded-lg p-4 max-w-2xl mx-auto mb-4">
                          <p className="text-light/80 text-sm mb-2">
                            Different spreads provide different levels of
                            insight:
                          </p>
                          <ul className="text-sm text-left">
                            <li className="mb-2 flex gap-2">
                              ...
                              <div className="text-light/70">
                                ...
                                Quick insight for a specific question
                              </div>
                            </li>
                            <li className="mb-2 flex gap-2">
                              <div className="text-accent min-w-5">•</div>
                              <div className="text-light/70">
                                ...
                                Understand your journey through time
                              </div>
                            </li>
                ...
                >
                  <div className="bg-dark/40 backdrop-blur-sm rounded-lg p-5 border border-light/10">
                    <h4 className="flex items-center gap-2 font-medium text-accent mb-3">
                      ...
                      About {selectedSpread === "celtic-cross"
                        ? "the"
                        : ""}{" "}
                ...
                >
                  <div className="bg-dark/40 backdrop-blur-sm rounded-lg p-5 border border-light/10">
                    <label
                      htmlFor="question"
                      className="block text-light mb-2 text-base font-medium"
                    >
                      Ask Your Question
                    </label>
                    <p className="text-light/70 text-sm mb-3">
                      For the most accurate reading, be clear and specific about
                      what you want to know. Your question will provide context
                      to your reading.
                    </p>
                    <textarea
                      id="question"
                    ...
                    <div className="flex justify-between mt-2">
                      <p className="text-light/50 text-xs italic">
                        Your question will be private and only visible to you
                      </p>
                      ...
                      onClick={() => {
                        ...
                        if (userQuestion.trim()) {
                          toast({
                            ...
                            description:
                              "Now select a card from the deck below to reveal your reading",
                            variant: "default",
                          });
                        }
                      }}
