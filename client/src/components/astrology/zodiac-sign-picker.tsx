  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-light/70 max-w-xl mx-auto">{description}</p>
      </div>
...
function ZodiacSignGrid({
  ...
  const getSignColor = (sign: string, element: string): string => {
    ...
    switch (element.toLowerCase()) {
      case "fire":
        return "from-red-500/30 to-orange-500/30 border-red-500/40 hover:border-red-500/70";
      case "earth":
        return "from-green-500/30 to-emerald-500/30 border-green-500/40 hover:border-green-500/70";
      case "air":
        return "from-blue-500/30 to-indigo-500/30 border-blue-500/40 hover:border-blue-500/70";
      case "water":
        return "from-cyan-500/30 to-blue-500/30 border-cyan-500/40 hover:border-cyan-500/70";
      default:
        return "from-gray-500/30 to-slate-500/30 border-slate-500/40 hover:border-slate-500/70";
    }
  };
