/**
 * Disable Away Mode Script
 * 
 * This script disables away mode for the autonomous agent system.
 */
...
// Display banner
console.log(`${COLORS.bgYellow}${COLORS.black}${COLORS.bright}                                                                                ${COLORS.reset}`);
console.log(`${COLORS.bgYellow}${COLORS.black}${COLORS.bright}                     DISABLING AWAY MODE FOR AUTONOMOUS AGENTS                  ${COLORS.reset}`);
console.log(`${COLORS.bgYellow}${COLORS.black}${COLORS.bright}                                                                                ${COLORS.reset}`);
console.log('');
...
try {
  ...
  if (envContent.match(regex)) {
    ...
    envContent = envContent.replace(regex, 'AGENT_AWAY_MODE=false');
  } else {
    // Add new variable
    envContent += '\nAGENT_AWAY_MODE=false';
  }
...
// Restart agents
console.log(`${COLORS.yellow}Restarting agents with away mode disabled...${COLORS.reset}`);
