...
/**
 * Run All Agents Script for Mystic Arcana
 * 
 * This script runs all autonomous agents in parallel.
 */
...
function runAgent(agentType) {
  ...
  const process = spawn('node', [path.join(__dirname, 'autonomous-agent.js'), agentType], {
    stdio: 'inherit'
  });
