...
/**
 * Run All MCP Agents Script for Mystic Arcana
 * 
 * This script runs all MCP-based autonomous agents in parallel.
 */
...
function runAgent(agentType) {
  ...
  const process = spawn('node', [path.join(__dirname, 'mcp-agent.js'), agentType], {
    stdio: 'inherit'
  });
...
// Main function
function main() {
  console.log('Starting all MCP agents...');
